...
if __name__ == '__main__':
    # AS CHAMADAS ABAIXO EXECUTAM A FUNÇÃO DOWNLOAD_TIME E EXIBEM COMO RESPOSTA O TEMPO ESTIMADO PARA DOWNLOAD.

    print(download_time(1, 'MB', 2, 'MB'))
    print(download_time(2, 'GB', 150, 'MB'))